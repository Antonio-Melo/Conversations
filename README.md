...
## Bigger Font
<p These feature supposedly allows the user to chooise a **bigger** font that will be apllied in **every component** of the app. />
<p Even though the font is **slightly** changed, the definition menu **remains the same**./>
<p align="center">
